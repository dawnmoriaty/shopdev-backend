...
public class AddressController {
    ...
    @GetMapping
    public ResponseEntity<ApiResponse<AddressResponseDTO>> getAllAddresses(){
        ...
        ApiResponse<AddressResponseDTO> response = ApiResponse.<AddressResponseDTO>builder()
                ...
                .data((AddressResponseDTO) addresses)
    ...
    @PostMapping
    public ResponseEntity<ApiResponse<AddressResponseDTO>> createAddress(@RequestBody AddressRequestDTO addressRequestDTO){
